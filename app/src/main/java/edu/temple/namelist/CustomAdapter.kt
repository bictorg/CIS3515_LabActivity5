...
class CustomAdapter(private var names: List<String>, private val context: Context) : BaseAdapter() {
    ...
    // We update the data and notify the adapter that the data has changed
